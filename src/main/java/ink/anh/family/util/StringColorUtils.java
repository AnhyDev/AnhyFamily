...
public class StringColorUtils {
    ...
    public static String MARRY_PRIEST_MALE_PREFIX_COLOR = "#0a71f0";
    public static String MARRY_PRIEST_MALE_NICKNAME_COLOR = "#ADD8E6";
    public static String MARRY_PRIEST_FEMALE_PREFIX_COLOR = "#800080";
    public static String MARRY_PRIEST_FEMALE_NICKNAME_COLOR = "#FF69B4";
    public static String MARRY_PRIEST_NONBINARY_PREFIX_COLOR = "#808080";
    public static String MARRY_PRIEST_NONBINARY_NICKNAME_COLOR = "#32CD32";
    public static String PRIVATE_MARRY_PREFIX_COLOR = "#8B4513";
    public static String PRIVATE_MARRY_NICKNAME_COLOR = "#F4A460";
    public static String BRIDE_MALE_PREFIX_COLOR = "#b59018";
    public static String BRIDE_MALE_NICKNAME_COLOR = "#3db6b8";
    public static String BRIDE_FEMALE_PREFIX_COLOR = "#FFC0CB";
    public static String BRIDE_FEMALE_NICKNAME_COLOR = "#FF1493";
    public static String BRIDE_NONBINARY_PREFIX_COLOR = "#40E0D0";
    public static String BRIDE_NONBINARY_NICKNAME_COLOR = "#20B2AA";
    ...
    private static void loadColors(FileConfiguration config) {
        ...
        MARRY_PRIEST_MALE_PREFIX_COLOR = getColorFromConfig(config, "marry_priest_male_prefix_color", MARRY_PRIEST_MALE_PREFIX_COLOR);
        MARRY_PRIEST_MALE_NICKNAME_COLOR = getColorFromConfig(config, "marry_priest_male_nickname_color", MARRY_PRIEST_MALE_NICKNAME_COLOR);
        MARRY_PRIEST_FEMALE_PREFIX_COLOR = getColorFromConfig(config, "marry_priest_female_prefix_color", MARRY_PRIEST_FEMALE_PREFIX_COLOR);
        MARRY_PRIEST_FEMALE_NICKNAME_COLOR = getColorFromConfig(config, "marry_priest_female_nickname_color", MARRY_PRIEST_FEMALE_NICKNAME_COLOR);
        MARRY_PRIEST_NONBINARY_PREFIX_COLOR = getColorFromConfig(config, "marry_priest_nonbinary_prefix_color", MARRY_PRIEST_NONBINARY_PREFIX_COLOR);
        MARRY_PRIEST_NONBINARY_NICKNAME_COLOR = getColorFromConfig(config, "marry_priest_nonbinary_nickname_color", MARRY_PRIEST_NONBINARY_NICKNAME_COLOR);
        PRIVATE_MARRY_PREFIX_COLOR = getColorFromConfig(config, "private_marry_prefix_color", PRIVATE_MARRY_PREFIX_COLOR);
        PRIVATE_MARRY_NICKNAME_COLOR = getColorFromConfig(config, "private_marry_nickname_color", PRIVATE_MARRY_NICKNAME_COLOR);
        BRIDE_MALE_PREFIX_COLOR = getColorFromConfig(config, "bride_male_prefix_color", BRIDE_MALE_PREFIX_COLOR);
        BRIDE_MALE_NICKNAME_COLOR = getColorFromConfig(config, "bride_male_nickname_color", BRIDE_MALE_NICKNAME_COLOR);
        BRIDE_FEMALE_PREFIX_COLOR = getColorFromConfig(config, "bride_female_prefix_color", BRIDE_FEMALE_PREFIX_COLOR);
        BRIDE_FEMALE_NICKNAME_COLOR = getColorFromConfig(config, "bride_female_nickname_color", BRIDE_FEMALE_NICKNAME_COLOR);
        BRIDE_NONBINARY_PREFIX_COLOR = getColorFromConfig(config, "bride_nonbinary_prefix_color", BRIDE_NONBINARY_PREFIX_COLOR);
        BRIDE_NONBINARY_NICKNAME_COLOR = getColorFromConfig(config, "bride_nonbinary_nickname_color", BRIDE_NONBINARY_NICKNAME_COLOR);
