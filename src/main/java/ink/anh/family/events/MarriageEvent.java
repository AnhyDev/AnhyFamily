...
public class MarriageEvent extends Event implements Cancellable {
    ...
    public MarriageEvent(Player player1, Player player2, Player priest, PlayerFamily playerFamily1, PlayerFamily playerFamily2, FamilyDetails familyDetails, ActionInitiator initiator) {
