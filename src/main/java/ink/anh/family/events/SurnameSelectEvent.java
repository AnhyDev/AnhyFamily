...
public class SurnameSelectEvent extends Event implements Cancellable {
    ...
    public SurnameSelectEvent(Player player, PlayerFamily playerFamily, ActionInitiator initiator) {
        this.player = player;
