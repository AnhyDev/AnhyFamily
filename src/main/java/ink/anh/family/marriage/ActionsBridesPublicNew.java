...
public class ActionsBridesPublicNew extends Sender {
	...
	public ActionsBridesPublicNew (AnhyFamily familyPlugin){
	...
	public void accept(AsyncPlayerChatEvent event) {
	    ...
	    String marry1 = ":§b family_marry_vows_man";
	    String marry2 = ":§d family_marry_vows_woman";
	    String marry0 = ":§f family_marry_vows_nonbinary";
